...
{
    private final static String crawlStorageFolder = "C:/Users/shrey/data/crawl";
    ...
    private final static String name = "Shreya Wagle";
    private final static String id = "3298******";
    private final static String newssitecrawled  = "https://www.washingtonpost.com/";
    ...
    public static void saveStatistics(CrawlState sumState) throws Exception {
        ...
        abortedUrlsCount=(sumState.attemptUrls.size())-(sumState.visitedUrls.size()+failedUrlsCount);
