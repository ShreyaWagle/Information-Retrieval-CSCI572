...
$limit = 10;
$path ="/home/shreya1994/Downloads/WP/WP/WP/";

//Read the mapping file
$file = fopen('/home/shreya1994/Downloads/WP/WP/WPMap.csv', 'r');
$csv = array();
...
<script>
    $(function() {
        var URL_PREFIX = "http://localhost:8983/solr/shreyacore/suggest?indent=on&q=";
...
<label for="q">Washington Post Search</label><br><br>
...
if ($results) {
if($flag == 1){ ?>
<p>Showing results for: <a href="http://localhost/ui.php?rank=<?php echo $_REQUEST['optn']; ?>&f=true&q=<?php echo $query; ?>"><?php echo $query;?></a> </p>
<p>Search instead for: <a href="http://localhost//solr-php-client/ui.php?q=<?php echo $original_query; ?>&optn=default"><?php echo $original_query;?></a> </p>
<!--<p>Search instead for: <a href="http://localhost/ui.php?rank=<?php echo $_REQUEST['optn']; ?>&f=true&q=<?php echo $original_query; ?>"><?php echo $original_query;?></a> </p> -->
<?php }
